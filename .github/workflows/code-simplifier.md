...
source: github/gh-aw/.github/workflows/code-simplifier.md@9f9af349b8b72e8da7d9adf3ebdbb0f84654760b
---
...
- behavior is preserved
  - `bun run typecheck`, `bun run lint`, `bun run test:coverage`, and `npx vite build` succeed
