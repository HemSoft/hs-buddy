...
if ($Help) {
    Write-Output ""
    Write-Output "ralph-improve-crap-score-repeat.ps1 - Repeated CRAP Score Improver"
    Write-Output "Runs ralph-improve-crap-score.ps1 N times in autopilot mode."
    ...
    Write-Output "  ralph-improve-crap-score-repeat"
    Write-Output "  ralph-improve-crap-score-repeat -Times 5"
    Write-Output "  ralph-improve-crap-score-repeat -Times 10 -Model sonnet -WorkUntil 08:00"
    Write-Output "  ralph-improve-crap-score-repeat -Times 3 -Agents auditor-crap-score"
    Write-Output ""
    exit 0
}
...
if (-not (Test-Path $targetScript)) {
    Write-Error "ralph-improve-crap-score.ps1 not found at: $targetScript" -ErrorAction Continue
    exit 1
}
...
for ($i = 1; $i -le $Times; $i++) {
    Write-Information ""
    Write-Information "===================================="
    Write-Information "== CRAP score improvement run $i of $Times"
    Write-Information "===================================="
...
Write-Information ""
Write-Information "===================================="
Write-Information "== All $Times CRAP score improvement runs complete!"
Write-Information "===================================="
