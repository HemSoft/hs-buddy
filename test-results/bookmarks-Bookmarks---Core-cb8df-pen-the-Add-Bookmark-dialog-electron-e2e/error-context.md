...
- Name: bookmarks.spec.ts >> Bookmarks - Core Interactions >> should open the Add Bookmark dialog
- Location: e2e\bookmarks.spec.ts:95:3
...
Locator: locator('[title="Add bookmark"], button:has-text("Add")').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[title="Add bookmark"], button:has-text("Add")').first()
