...
if ($Help) {
    Write-Output ""
    Write-Output "ralph-improve-test-coverage-repeat.ps1 - Repeated Test Coverage Improver"
    Write-Output "Runs ralph-improve-test-coverage.ps1 N times in autopilot mode."
    ...
    Write-Output "  ralph-improve-test-coverage-repeat"
    Write-Output "  ralph-improve-test-coverage-repeat -Times 5"
    Write-Output "  ralph-improve-test-coverage-repeat -Times 10 -Model sonnet -WorkUntil 08:00"
    Write-Output "  ralph-improve-test-coverage-repeat -Times 3 -Agents pr-review-quality"
    Write-Output ""
    exit 0
}
...
if (-not (Test-Path $targetScript)) {
    Write-Error "ralph-improve-test-coverage.ps1 not found at: $targetScript" -ErrorAction Continue
    exit 1
}
...
for ($i = 1; $i -le $Times; $i++) {
    Write-Information ""
    Write-Information "===================================="
    Write-Information "== Test coverage improvement run $i of $Times"
    Write-Information "===================================="
...
Write-Information ""
Write-Information "===================================="
Write-Information "== All $Times test coverage improvement runs complete!"
Write-Information "===================================="
