...
describe('getDiffLineClass', () => {
  it('returns hunk class for @@ lines', () => {
    expect(getDiffLineClass('@@ -1,3 +1,5 @@')).toBe('repo-commit-diff-line repo-commit-diff-line-hunk')
  })

  it('returns added class for + lines', () => {
    expect(getDiffLineClass('+added line')).toBe('repo-commit-diff-line repo-commit-diff-line-added')
  })

  it('returns removed class for - lines', () => {
    expect(getDiffLineClass('-removed line')).toBe('repo-commit-diff-line repo-commit-diff-line-removed')
  })
