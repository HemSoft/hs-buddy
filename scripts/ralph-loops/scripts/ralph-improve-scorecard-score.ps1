...
if ($Help) {
    ...
    Write-Host "  -Branch <name>         Override branch name (default: feature/improve-scorecard)"
...
$defaultPrompt = "Improve the scorecard score for this repo. Your report is at this url: https://upgraded-adventure-j192emp.pages.github.io/scorecard-summary.html"
$effectivePrompt = if ($Prompt) { $Prompt } else { $defaultPrompt }
$effectiveBranch = if ($Branch) { $Branch } else { 'feature/improve-scorecard' }
