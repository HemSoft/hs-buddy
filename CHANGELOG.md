...
- Update Convex version metadata

## [0.1.1263] - 2026-09-22

### Fixed

- Use App identity for native auto-merge enrollment
...
- Bound recovery transaction payloads (#720)

## [0.1.1258] - 2026-09-18

### Fixed

- Recover missed schedules atomically (#720)
...
- Preserve Shiki WebAssembly under CSP (#716)

## [0.1.1255] - 2026-09-18

### Fixed

- Harden production content security policy (#716)

## [0.1.1254] - 2026-09-15

### Changed

- Gate markdown lint (#711)
...
- Integrate security policy with main
...
- Integrate accessibility baseline with main
...
- Keep Dependabot contract checks bounded (#687)

## [0.1.1195] - 2026-09-12

### Fixed

- Address Dependabot workflow review (#687)

## [0.1.1194] - 2026-09-12

### Fixed

- Isolate Dependabot lockfile writes (#687)
...
- Move dashboard off reserved Windows port
...
- Update activePRCacheKeysRef in commit phase using useLayoutEffect

## [0.1.1130] - 2026-09-05

### Changed

- Share useMigration mock harness and guard async plan readiness

## [0.1.1129] - 2026-09-05

### Fixed

- Synchronize accounts in layout effect and assert strict mode non-duplication
...
- Clarify CodeQL scan scope (#648)

## [0.1.1123] - 2026-09-05

### Changed

- Remove disposable CodeQL fixture (#648)

## [0.1.1122] - 2026-09-05

### Changed

- Enable CodeQL merge protection (#648)
...
- Move lesson guidance out of agents file (#637)

## [0.1.1106] - 2026-09-04

### Fixed

- Enforce major-only Electron badge (#636)

## [0.1.1105] - 2026-09-04

### Changed

- Synchronize README badges (#636)

## [0.1.1104] - 2026-09-04

### Changed

- Add mutation quality gate (#635)
...
- Address current-head review feedback

## [0.1.1071] - 2026-09-01

### Fixed

- Satisfy typed lint for uptime timer

## [0.1.1070] - 2026-09-01

### Changed

- Isolate one-second display updates (#624)
...
- Prioritize open repository activity (#610)

## [0.1.1062] - 2026-08-28

### Fixed

- Make repository cards full width

## [0.1.1061] - 2026-08-28

### Fixed

- Redesign active repository workbench
...
- Reset cache freshness mock

## [0.1.983] - 2026-08-23

### Fixed

- Refresh stale repo counts (#576)

## [0.1.982] - 2026-08-23

### Fixed

- Include private user repositories
...
- Apply 2026-08-21 audit nits without behavior changes
...
- Preserve defaults for undefined props
...
- Initialize new indicators without render refs
...
- Buffer output across stream chunks
...
- Complete About modal semantics
...
- Prevent Node shim startup crash
...
- Resolve high-severity audit advisories

## [0.1.936] - 2026-08-02

### Fixed

- Audit the production renderer with Lighthouse
...
- Cover user billing fallback

## [0.1.925] - 2026-07-26

### Fixed

- Tighten finance benchmark fixtures
...
- Remove redundant slack env fallbacks
...
- Remove unused org repos section
...
- Refresh Dependabot backlog audit

## [0.1.818] - 2026-06-13

### Fixed

- Include apphost TypeScript config in checks

## [0.1.817] - 2026-06-13

### Changed

- Refresh Aspire generated SDK

## [0.1.816] - 2026-06-12

### Changed

- Record archived Dependabot blocker

## [0.1.815] - 2026-06-12

### Changed

- Record Dependabot backlog status
...
- Update code simplifier gh-aw runtime

## [0.1.794] - 2026-06-06

### Fixed

- Avoid gh-aw footer install template lookup

## [0.1.793] - 2026-06-06

### Fixed

- Add code simplifier noop reminder

## [0.1.792] - 2026-06-06

### Changed

- Add Codex code simplifier workflow

## [0.1.791] - 2026-06-06

### Changed

- Remove SFL and gh-aw workflows

## [0.1.790] - 2026-06-05

### Fixed

- Use valid GraphQL fragments in PR history

## [0.1.789] - 2026-06-03

### Fixed

- Use CodexBar Copilot metrics snapshot
- Validate dependabot lockfile updates
...
- Clear react hook dependency diagnostics

## [0.1.784] - 2026-05-31

### Changed

- Clear remaining async loop diagnostics

## [0.1.783] - 2026-05-31

### Changed

- Document bounded async mutation loops

## [0.1.782] - 2026-05-31

### Changed

- Clarify sequential electron IO loops

## [0.1.781] - 2026-05-31

### Changed

- Parallelize GitHub org searches

## [0.1.780] - 2026-05-31

### Changed

- Parallelize GitHub user commit counts

## [0.1.779] - 2026-05-31

### Changed

- Document ordered GitHub async loops

## [0.1.778] - 2026-05-31

### Changed

- Parallelize pull request thread stats
...
- Use typographic ellipses

## [0.1.775] - 2026-05-31

### Changed

- Reduce pollen hook complexity

## [0.1.774] - 2026-05-31

### Changed

- Reduce review hook complexity
...
- Make benchmarks reliable PR gate
...
- Expand pollen display with species-level detail
...
- Set AppUserModelId on Windows to prevent taskbar icon fallback
