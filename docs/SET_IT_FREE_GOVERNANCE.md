...
Apply `agent:human-required` to any issue to keep it outside automated claiming.

Repository-level and directory-level opt-out files are not currently implemented in
the active hs-buddy workflow set.
