...
if ($Help) {
    Write-Output ""
    Write-Output "ralph-improve-quality-repeat.ps1 - Repeated Quality Improver"
    Write-Output "Runs ralph-improve-quality.ps1 N times in autopilot mode."
    ...
    Write-Output "  ralph-improve-quality-repeat"
    Write-Output "  ralph-improve-quality-repeat -Times 5 -Stack dotnet"
    Write-Output "  ralph-improve-quality-repeat -Times 10 -Model sonnet -WorkUntil 08:00"
    Write-Output "  ralph-improve-quality-repeat -Times 3 -Agents auditor-code-quality"
    Write-Output ""
    exit 0
}
...
if (-not (Test-Path $targetScript)) {
    Write-Error "ralph-improve-quality.ps1 not found at: $targetScript" -ErrorAction Continue
    exit 1
}
...
for ($i = 1; $i -le $Times; $i++) {
    Write-Information ""
    Write-Information "===================================="
    Write-Information "== Quality improvement run $i of $Times (stack: $Stack)"
    Write-Information "===================================="
...
Write-Information ""
Write-Information "===================================="
Write-Information "== All $Times quality improvement runs complete!"
Write-Information "===================================="
