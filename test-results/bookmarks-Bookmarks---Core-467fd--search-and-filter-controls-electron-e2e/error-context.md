...
- Name: bookmarks.spec.ts >> Bookmarks - Core Interactions >> should have search and filter controls
- Location: e2e\bookmarks.spec.ts:106:3
...
Locator: getByPlaceholder('Search bookmarks…')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByPlaceholder('Search bookmarks…')
