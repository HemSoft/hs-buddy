...
- Name: bookmarks.spec.ts >> Bookmarks - Loading & Connectivity >> should display a connection error when Convex is unreachable
- Location: e2e\bookmarks.spec.ts:56:3
...
Locator: locator('.bookmark-card, :text("No bookmarks yet"), :text("Unable to load"), :text("offline"), :text("connection")').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('.bookmark-card, :text("No bookmarks yet"), :text("Unable to load"), :text("offline"), :text("connection")').first()
